...
const Members = () => {
  ...
  return (
    <div id="team" className="relative py-20 bg-gray-900">
      {/* Terminal grid background */}
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <div className="h-full w-full" style={{
          backgroundImage: 'linear-gradient(0deg, rgba(56, 189, 248, 0.2) 1px, transparent 1px), linear-gradient(90deg, rgba(56, 189, 248, 0.2) 1px, transparent 1px)',
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl font-bold text-blue-300 mb-4 font-mono">Team Members<span className="text-blue-500 animate-pulse">_</span></h2>
          <p className="text-blue-200/80 max-w-2xl mx-auto font-mono">
            <span className="text-green-400">$</span> whoami | grep "organizers"
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="border border-blue-500/30 rounded-lg overflow-hidden bg-gray-900/60 backdrop-blur-sm shadow-lg h-full">
                {/* Terminal header */}
                <div className="bg-gray-800/80 px-3 py-1.5 flex items-center border-b border-blue-500/20">
                  ...
                  <div className="flex-1 text-center font-mono text-xs text-blue-300/70">user-profile.sh</div>
                </div>

                {/* Member content */}
                <div className="p-4 font-mono">
                  <div className="flex flex-col sm:flex-row items-center mb-4">
                    <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-blue-500/30 mb-4 sm:mb-0 sm:mr-4">
                      <img 
                        src={member.image} 
                        alt={member.name}
                    ...
                    <div className="text-center sm:text-left">
                      <div className="text-blue-200 font-bold">{member.name}</div>
                      <div className="text-green-400 text-sm">{member.role}</div>
                    </div>
                  </div>

                  {/* Terminal-style output */}
                  <div className="mt-4 bg-blue-900/10 rounded p-3 border border-blue-500/20">
                    <div className="text-blue-300 mb-1 text-xs">$ cat bio.txt</div>
                    <div className="text-blue-100/90">{member.bio}</div>
                  </div>
